...
const LoginScreen = (props: LoginScreenProps) => {
    ...
    const handleLogin = () => {
        ...
        navigation.navigate(ContantsNavigator.HOME_SCREEN);
    }
        ...
        <View style={styles.container}>
            <View style={styles.content}>
                ...
                <TextInputW
                    ...
                    leftIcon={{ name: 'email', color: ColorIcon.icon }}
                ...
                <TextInputW
                    ...
                    leftIcon={{ name: 'password', color: ColorIcon.icon }}
                ...
                <View style={styles.viewRadioCheck}>
                    ...
                    >
                        <SvgXml
                            xml={svgApp({ name: remember ? 'radio-checked' : 'radio-unChecked', size: 20 })}
                        />
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={handleRemember}
